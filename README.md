...
├── test_codegen.py              # Playwright codegen-generated script
├── test_example.py              # Basic Playwright example
├── test_filtering.py            # Filtering elements/data
├── test_login.py                # Login automation
├── test_login_css_xpath.py      # Login using CSS & XPath selectors
│
...
Using CSS selectors vs XPath
Automating navigation across pages
Using Playwright codegen for rapid scripting
▶️ How to Run
